...
class GK extends JFrame {
	GK() {
		...
		JLabel l7 = new JLabel("GENERAL KNOWLEDGE");
		...
		JLabel l1 = new JLabel("Science");
		l1.setForeground(Color.white);
		p1.setLayout(null);
		l1.setFont(new Font("arial", Font.BOLD, 40));
		l1.setBounds(120, 10, 250, 80);
		p1.add(l1);

        JLabel lb1=new JLabel("10 Questions covering the basics of Science");
        lb1.setForeground(Color.white);
        lb1.setFont(new Font("arial", Font.BOLD, 16));
		lb1.setBounds(30, 100, 400, 50);
        p1.add(lb1);
		...
		l2.setBounds(120, 10, 250, 80);
		p2.add(l2);

        JLabel lb2=new JLabel("10 Questions covering the basics of History");
        lb2.setForeground(Color.white);
        lb2.setFont(new Font("arial", Font.BOLD, 16));
		lb2.setBounds(30, 100, 400, 50);
        p2.add(lb2);
		...
		JLabel l3 = new JLabel("Indian Politics");
		l3.setForeground(Color.white);
		p3.setLayout(null);
		l3.setFont(new Font("arial", Font.BOLD, 40));
		l3.setBounds(80, 10, 400, 80);
		p3.add(l3);

        JLabel lb3=new JLabel("10 Questions covering the basics of Indian politics");
		...
		JLabel l4 = new JLabel("Award Section");
        ...
        JLabel lb4=new JLabel("10 Questions covering the basics of Award section");
		...
		JLabel l5 = new JLabel("Indian Culture");
		l5.setForeground(Color.white);
		p5.setLayout(null);
		l5.setFont(new Font("arial", Font.BOLD, 40));
		l5.setBounds(60, 10, 400, 80);
		p5.add(l5);

        JLabel lb5=new JLabel("10 Questions covering the basics of culture");
		...
		JLabel l6 = new JLabel("Indian Geography");
		l6.setForeground(Color.white);
		p6.setLayout(null);
		l6.setFont(new Font("arial", Font.BOLD, 40));
		l6.setBounds(30, 10, 400, 80);
		p6.add(l6);

        JLabel lb6=new JLabel("10 Questions covering the basics of geography");
